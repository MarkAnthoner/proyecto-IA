...
class arbolClasificacion:
    ...
    def mapaCalor(self): 
        directorio = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Datos/arbolYbosque/arbol/'+self.nombreArchivo)
    ...
    def aplicacionAlgoritmo(self):
        ...
        self.scoreClasificacion = accuracy_score(Y_validation, Y_ClasificacionAD)
        ...
        plot_tree(ClasificacionAD, feature_names = self.datosColumnas)
    ...
    def calculoItemClasificacion(self, itemDataframe):
        ...
        resultadoClasificacion = int(ClasificacionAD.predict(itemACalcular))
